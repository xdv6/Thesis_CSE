...
* OSC_POSE ( OSC = Operational Space Control, POSE = Refers to the combination of the position and orientation of the end-effector): Gripper moves sequentially and linearly in x, y, z direction, then sequentially rotates in x-axis, y-axis,
...
if __name__ == "__main__":
    ...
    # Define the pre-defined controller actions to use (action_dim, num_test_steps = number of dimensions the demo wil test, test_value = The magnitude of the action to be taken in the perturbation test for each dimension (how much the robot should move in each direction)
    controller_settings = {
        "OSC_POSE": [6, 6, 0.1],
