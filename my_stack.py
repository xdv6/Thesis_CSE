...
class Stack(SingleArmEnv):
    ...
    def _load_model(self):
        ...
        if self.placement_initializer is not None:
            pass
            # xdv adpatation for custom sampler
    ...
    def _setup_references(self):
        ...
        # xdv: add cubeC and cubeD body ids
    ...
    def _setup_observables(self):
        ...
        if self.use_object_obs:
            ...
            # xdv: add cubeC and cubeD sensors 
            ...
            sensors = [cubeA_pos, cubeA_quat, cubeB_pos, cubeB_quat, gripper_to_cubeA, gripper_to_cubeB, cubeA_to_cubeB, cubeC_pos, cubeC_quat, cubeD_pos, cubeD_quat, gripper_to_cubeC, gripper_to_cubeD]
